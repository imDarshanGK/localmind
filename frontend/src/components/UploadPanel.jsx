...
export default function UploadPanel({ sessionId, documents, onUploaded, onClose }) {
  ...
  return (
    <div data-testid="upload-panel" className="border-b border-gray-800 bg-gray-900 px-5 py-4 shrink-0 transition-all duration-200">
      ...
      {/* FIXED (#570): Use conditional rendering instead of conditional class names to ensure node removal */}
      {!isCollapsed && (
        <div>
          {/* Drop zone */}
          <div
