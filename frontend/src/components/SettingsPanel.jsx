...
export default function SettingsPanel({ settings, onSave, onClose }) {
  // FIXED (#576): Safeguarded initialization via optional chaining to prevent property access crashes on null/empty payloads
  ...
  return (
    <div className="border-b border-gray-800 bg-gray-900 px-5 py-4 shrink-0">
      ...
      {isEmptyState ? (
        ...
        /* Standard workspace configuration input controls */
        <>
