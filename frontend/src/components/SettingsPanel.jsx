...
export default function SettingsPanel({ settings, onSave, onClose }) {
  ...
  return (
    <div className="border-b border-gray-800 bg-gray-900 px-5 py-4 shrink-0 transition-all duration-300">
      ...
      {/* FIXED (#581): Conditional content workspace rendering container */}
      {isExpanded && (
        <>
          <div className="grid grid-cols-2 gap-x-6 gap-y-3 text-xs">
            ...
            {/* CLEANED UP THE THEME ERROR INCOMING FROM PREVIOUS TEMPLATE STACK */}
            <Field label="Theme">
