...
const LANGUAGES = [{code:"en",label:"English"},{code:"hi",label:"हिन्दी"},{code:"ta",label:"தமிழ்"},{code:"te",label:"తెలుగు"},{code:"pt-BR",label:"Português"},{code:"kn",label:"ಕನ್ನಡ"},{code:"fr",label:"Français"}];
