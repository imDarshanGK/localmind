  ...
  return (
    ...
    >
      ...
      {isEmptyState ? (
        ...
        isExpanded && (
          <>
            {/* FIXED (#579): Fluid responsive grid layout adapting from 1 column on mobile to 2 columns on desktop layout */}
            ...
            {/* FIXED (#579): Action wrapper rows stack vertically on mobile to eliminate text truncation */}
            <div className="flex flex-col sm:flex-row gap-2 mt-5 pt-3 border-t border-gray-800 justify-between items-center w-full">
              <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                <button 
                  ...
                  onClick={handleSave}
                  disabled={isSaving}
                  className="text-xs bg-purple-700 hover:bg-purple-600 disabled:bg-gray-800 text-white px-4 py-1.5 rounded-lg transition font-medium shadow-md w-full sm:w-auto text-center"
                >
              ...
              <button 
                ...
                className={`text-[11px] px-3 py-1.5 rounded-lg transition font-medium border flex items-center justify-center gap-1.5 duration-200 w-full sm:w-auto mt-2 sm:mt-0
                  ${copied 
