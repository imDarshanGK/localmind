        ...
        >
          {editingId === s.id ? (
            ...
            >
              ...
              {s.message_count > 0 && (
                <span className="ml-1 text-gray-500 text-[10px] bg-gray-800/60 px-1.5 py-0.5 rounded-full shrink-0" data-testid={`msg-count-${s.id}`} aria-label={`${s.message_count} messages`}>
                  {s.message_count}
                </span>
              )}
            </button>
